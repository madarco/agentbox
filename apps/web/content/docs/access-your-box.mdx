...
The desktop has a window manager and an icon dock along the bottom — a Terminal button, a Browser button, and one icon per open window, so you can switch between windows or open a shell without leaving the viewer.
