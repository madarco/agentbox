...
| Method + path  | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| -------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `GET /custody` | Metadata of what the control box holds so a box created from either side is usable from both — agent credentials, project seeds, provider bake records, and per-box SSH keys: `{ enabled, entries: [{ path, size, sha256, mode, updatedAt }] }`. **Value bytes are never returned** (same contract as `agentbox hub custody list`). `enabled: false` on a hub with no custody (a localhost hub). Optional `?prefix=` scopes to a custody scope (`agents` \| `projects` \| `prepared` \| `boxes`) or a `scope/subject` (e.g. `boxes/box-abc`); a malformed prefix is `400`. Drives the web UI's **Custody** page. |
