...
| `GET /boxes/{id}/agent`    | The box's in-box coding-agent status snapshot (activity, plan/question, session title) from the persisted status store: `{ claude }`. Backs `agentbox agent state`/`wait-for`/`get-plan-question`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
`projectIndex`, `vncEnabled`, `gitWorktrees`, `shellCount`, per-agent session
titles, and `claudeActivity`/`codexActivity`. `vncEnabled` — not `vncUrl` — is the
