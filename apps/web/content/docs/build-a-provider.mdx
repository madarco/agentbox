...
Once your provider works end to end, open a PR against [madarco/agentbox](https://github.com/madarco/agentbox) to add a short page for it under **Community Providers** in these docs — so other users can discover and install it.
</Callout>
