...
in your attached session; it defaults to _no_, so nothing reaches your remotes
unless you say yes.
...
<Callout title="WHY">
  The safety model: the agent runs unsupervised inside an isolated box, and every push to a remote
  runs on your machine, as you, only when you allow it. No secrets enter the box.
</Callout>
