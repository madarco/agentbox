...
Running boxes pick up a new grant within about 15 seconds. No restart, no image rebuild.
...
You get an approval prompt naming the box, the binary, and the reason. Approve and the command works immediately in that running box.
