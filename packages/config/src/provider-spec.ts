 ...
 *
 * It lives in `@agentbox/config` — beside the PROVIDERS table it is really about
 * — because BOTH the CLI and the hub have to read the same spec: the CLI when it
 * routes a create, the hub when its worker is handed one. A second parser is
