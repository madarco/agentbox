...
export const daytonaProvider: Provider = {
  ...
  baseFingerprint: (agentInstall) => currentDaytonaBaseFingerprintLive(agentInstall),
};
...
export const providerModule: ProviderModule = {
  ...
  currentBaseFingerprintLive: (agentInstall) => currentDaytonaBaseFingerprintLive(agentInstall),
  sizeIgnoredReason,
  doctorChecks,
};
