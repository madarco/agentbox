...
export function candidatesFor(
  ...
  const cliRelative: Record<string, string[]> = {
    ...
    'agentbox-tool-shim': ['hetzner/agentbox-tool-shim', 'docker/packages/sandbox-docker/scripts/agentbox-tool-shim'],
    ...
    'agentbox-identity-skill.md': ['hetzner/agentbox-identity-skill.md', 'docker/apps/cli/share/agentbox-identity/SKILL.md'],
  };
